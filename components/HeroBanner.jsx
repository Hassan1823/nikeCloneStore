...
const HeroBanner = () => {
  return (
    <div className='relative text-white text-[20px] w-full max-w-[1360px] mx-auto md:px-10'>
      <Carousel
        autoPlay={true}
        infiniteLoop={true}
        showStatus={false}
        ...
        renderArrowPrev={(clickHandler, havPrev) => (
          <div
        ...
        renderArrowNext={(clickHandler, havNext) => (
          <div
            onClick={clickHandler}
        ...
        <div>
          ...
          bg-white absolute bottom-[25px] md:bottom-[70px] left-0 text-black/[0.9] text-[15px]
